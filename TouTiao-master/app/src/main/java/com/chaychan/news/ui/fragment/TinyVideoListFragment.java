...
*    Author:GeChen
*    Date:2019/3/20
*    Description:展示每个微视频列表的fragment
*/
public class TinyVideoListFragment extends BaseFragment<NewsListPresenter> implements lNewsListView, BGARefreshLayout.BGARefreshLayoutDelegate, BaseQuickAdapter.RequestLoadMoreListener{
    private static final String TAG = TinyVideoListFragment.class.getSimpleName();
    ...
    private boolean isTinyVideoList;
    ...
    protected int provideContentViewId() {
        return R.layout.fragment_tiny_video_list;
    }
    ...
    public void onStart() {
        super.onStart();
        registerEventBus(TinyVideoListFragment.this);
    }

    @Override
    public void onStop() {
        super.onStop();
        unregisterEventBus(TinyVideoListFragment.this);
    }
